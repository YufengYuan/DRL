...
class ReplayBuffer(object):
    ...
    def sample(self, batch_size, with_next_action=False, with_idxes=None):

        if with_idxes is None:
...
class PrioritizedReplayBuffer:
    ...
    def _sample_proportional(self, batch_size):
        res = []
        p_total = self._it_sum.sum(0, self.size - 2)

...
def sac(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
	...
	def compute_loss_q(data):
		...
		print(o.shape, a.shape, r.shape, o2.shape, d.shape)
		q1 = ac.q1(o, a)
		q2 = ac.q2(o, a)
	...
	def test_agent(test_returns):
		...
		np.save(f'SAC_HopperBulletEnv-v0_{seed}.npy',test_returns)
